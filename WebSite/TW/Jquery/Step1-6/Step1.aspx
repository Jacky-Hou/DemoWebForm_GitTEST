                            ...
                            $.ajax({
                                ...
                                $("#Hazard").autocomplete({
                                    ...
                                    select: function (event, ui2) {
                                        $("#Hazard").attr('size', ui2.item.value.length * 5);
                                    }
                                }).focus(function () {
...
<body>
    ...
    <form id="form1" action="Step2.aspx" method="post">
        <div>
            ...
            <input id="work" name="work" placeholder="輸入工作項目" />
        ...
        <div id="div_PHA">
            <div>
                ...
                <input id="Hazard" name="Hazard" placeholder="輸入危險分析" />
                <input type="button" id="btn_PHA" onclick="AddDataGridView(this.value, '危險分析');" value="新增危險分析" />
