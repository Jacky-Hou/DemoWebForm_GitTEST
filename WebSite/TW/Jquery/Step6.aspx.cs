...
namespace WebSite.Jquery
{
    public partial class Step6 : System.Web.UI.Page
    {
        ...
        protected List<string[]> ProjectArray()
        {
            ...
            workHazard.Add(new string[] { "空中階段", "[假設狀況法] 萬一雷達脫鎖", "中等", "很可能", "M9", "已完成", "已完成", "已完成", "已完成", "已完成" });
            workHazard.Add(new string[] { "空中階段", "[假設狀況法] 萬一未檢查武器電門是否在模擬位置", "災難", "頻繁", "EH1", "已完成", "已完成", "已完成", "已完成", "已完成" });
            workHazard.Add(new string[] { "起飛離場階段", "[初步危險分析法] 起飛離場時飛機故障", "輕微", "幾乎不", "L20", "已完成", "已完成", "已完成", "已完成", "已完成" });
            workHazard.Add(new string[] { "起飛離場階段", "[假設狀況法] 萬一滾行時發動機火警", "嚴重", "很少", "M11", "已完成", "已完成", "已完成", "已完成", "已完成" });
